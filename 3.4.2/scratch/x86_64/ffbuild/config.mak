...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang' --as='gas-preprocessor.pl -- xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-ffplay --disable-doc --enable-pic --enable-static --disable-shared --disable-asm --disable-encoders --disable-decoders --disable-demuxers --disable-muxers --disable-parsers --disable-filters --enable-encoder='h264,aac,libx264,pcm_*,*jpeg*' --enable-decoder='h264,aac,pcm_*,*jpeg*' --enable-muxer='h264,aac,pcm_*,flv,mp4,avi' --enable-demuxer='h264,aac,pcm_*,flv,mp4,avi' --enable-parser='h264,aac,*jpeg*' --enable-avfilter --enable-filter=anull --enable-gpl --enable-libx264 --extra-cflags='-arch x86_64 -mios-simulator-version-min=8.0 -I/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/include' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=8.0 -L/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/lib' --prefix=/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/thin/x86_64
prefix=/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/thin/x86_64
...
SRC_PATH=/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/ffmpeg-3.4.2
SRC_LINK=src
...
CFLAGS=  -arch x86_64 -mios-simulator-version-min=8.0 -I/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/include -std=c11 -fomit-frame-pointer -fPIC -pthread -D_THREAD_SAFE -I/usr/local/include/SDL2 -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch x86_64 -mios-simulator-version-min=8.0 -I/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/include -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch x86_64 -mios-simulator-version-min=8.0 -L/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-framework CoreFoundation -framework VideoToolbox -framework CoreMedia -framework CoreVideo -L/usr/local/lib -lSDL2 -liconv -L/usr/local/lib -lSDL2 -lx264 -lm  -lbz2 -lz -pthread -pthread -framework VideoToolbox -framework CoreImage -framework AVFoundation -framework AudioToolbox 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
...
avdevice_FFLIBS=avfilter avformat avcodec avutil
