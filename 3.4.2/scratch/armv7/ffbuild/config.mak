...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-ffplay --disable-doc --enable-pic --enable-static --disable-shared --disable-asm --disable-encoders --disable-decoders --disable-demuxers --disable-muxers --disable-parsers --disable-filters --enable-encoder='h264,aac,libx264,pcm_*,*jpeg*' --enable-decoder='h264,aac,pcm_*,*jpeg*' --enable-muxer='h264,aac,pcm_*,flv,mp4,avi' --enable-demuxer='h264,aac,pcm_*,flv,mp4,avi' --enable-parser='h264,aac,*jpeg*' --enable-avfilter --enable-filter=anull --enable-gpl --enable-libx264 --extra-cflags='-arch armv7 -mios-version-min=8.0 -fembed-bitcode -I/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/include' --extra-ldflags='-arch armv7 -mios-version-min=8.0 -fembed-bitcode -L/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/lib' --prefix=/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/thin/armv7
...
OBJCFLAGS=  
ASFLAGS=  -arch armv7 -mios-version-min=8.0 -fembed-bitcode -I/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/include -march=armv7-a -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch armv7 -mios-version-min=8.0 -fembed-bitcode -L/Users/lzj/Desktop/Project/FFmpeg-iOS-build-script/3.4.2/x264-iOS/lib  -march=armv7-a -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
