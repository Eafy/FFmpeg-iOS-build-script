...
SOURCE=`pwd`/freetype-2.8
BUILD_DIR=`pwd`/freetype-iOS # RELEASE_DIR
mkdir -p ${BUILD_DIR}
...
export CFLAGS="-arch ${ARCH} -fembed-bitcode -pipe -mdynamic-no-pic -Wno-trigraphs -fpascal-strings -O2 -Wreturn-type -Wunused-variable -fmessage-length=0 -fvisibility=hidden -miphoneos-version-min=$iphoneos -I/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk/usr/include/libxml2 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk"
export AR="/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/ar"
export LDFLAGS="-arch ${ARCH} -fembed-bitcode -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk -miphoneos-version-min=$iphoneos"
cd $SOURCE
./configure --prefix=$BUILD_DIR/lib --host="aarch64-apple-darwin" --enable-static --disable-shared --without-png
make clean
make
cp -rf ./include "${BUILD_DIR}"
cp objs/.libs/libfreetype.a "${BUILD_DIR}/lib/libfreetype-${ARCH}.a"
build_one="$ARCH"
...
lipo -create "${BUILD_DIR}/lib/libfreetype-armv7.a" "${BUILD_DIR}/lib/libfreetype-armv7s.a" "${BUILD_DIR}/lib/libfreetype-arm64.a" "${BUILD_DIR}/lib/libfreetype-i386.a" "${BUILD_DIR}/lib/libfreetype-x86_64.a" -output "${BUILD_DIR}/lib/libfreetype.a"
